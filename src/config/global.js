export const global = {
  nombrePrograma: 'Apropiación de los conceptos en ciberseguridad',
  codigo: '23310008',
  horas: 48,
  semanas: 4,
  modalidad: 'virtual',
  requisitosIngrso: [
    ...
    'Cumplir requisitos exigidos por el centro de formación.',
  ],
  // imagenBannerPrincipal: require('@/assets/curso/banner-princiapal.svg'),
  videoBannerPrincipal:
    '<iframe data-v-1f9e4816="" width="560" height="315" src="https://www.youtube.com/embed/7DCfBZAsU0g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen"></iframe>',
